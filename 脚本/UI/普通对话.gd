...
onready var balloon := $Hbox/Balloon
onready var margin := $Hbox/Balloon/Margin
onready var character_label := $Hbox/Balloon/Margin/Vbox/VBox/Character
onready var dialogue_label := $Hbox/Balloon/Margin/Vbox/VBox/Dialogue
onready var responses_menu := $Hbox/Balloon/Margin/Vbox/Vbox/Responses
onready var response_template := $Hbox/Balloon/Margin/Vbox/Vbox/ResponseTemplate
onready var player_name = $Hbox/玩家/玩家名
onready var npc_name = $Hbox/NPC/NPC名
